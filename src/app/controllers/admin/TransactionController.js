        ...
        if (
            ...
            if (parseInt(status) === 1) {
                ...
                const fee = Math.round(
                    (parseInt(price) * parseInt(transactionFee)) / 100
                );
                ...
                const updateSenderAccountBalance = async (price) => {
                    try {
                        const senderAccount = await getAccountByPhone(
                            senderPhone
                        );
                    ...
                    try {
                        ...
                        const newBalanceOfReceiver =
                            parseInt(isFeeForSender) === 1
                                ...
                                : parseInt(receiverAccount.balance) +
                                  price -
                                  fee;
